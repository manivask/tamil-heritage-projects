...
1. Open PowerShell and navigate to the directory:
   ```powershell
   cd c:\Users\maniv\all_ide_code_ws\apps\andriod_apps\attendance-tracker
   ```
...
You can also simply double-click the [index.html](file:///c:/Users/maniv/all_ide_code_ws/apps/andriod_apps/attendance-tracker/index.html) file to open it in Chrome, Edge, or Firefox.
