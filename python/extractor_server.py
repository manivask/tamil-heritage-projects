...
def save_content_to_portal(url, content):
    ...
    try:
        ...
        if is_nammalvar:
            target_file = os.path.join(base_dir, "html", "nammalvar.html")
            pioneer_name = "G. Nammalvar"
        elif is_orissa_balu:
            target_file = os.path.join(base_dir, "html", "orissa_balu.html")
            ...
            try:
                ...
                with urllib.request.urlopen(req, timeout=8) as resp:
                    ...
                    if img_url:
                        ...
                        images_dir = os.path.join(base_dir, "html", "images")
